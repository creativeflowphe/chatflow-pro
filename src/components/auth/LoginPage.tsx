...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 transition-colors duration-200">
      <div className="bg-[rgb(var(--color-bg-secondary))] rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="flex items-center justify-center mb-8">
          <div className="bg-blue-600 p-3 rounded-xl">
            <MessageSquare className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-[rgb(var(--color-text-primary))] ml-3">ChatFlow Pro</h1>
        </div>
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-[rgb(var(--color-text-secondary))] mt-2">
            {isLogin
              ...
              : 'Comece a automatizar seus chats hoje'}
          </p>
        </div>
          ...
          {!isLogin && (
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-[rgb(var(--color-border))] bg-[rgb(var(--color-bg-secondary))] text-[rgb(var(--color-text-primary))] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
